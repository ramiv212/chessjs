...
function canGameBegin(activeUsers) {
    if (activeUsers.length > 1) {
        let player1 = activeUsers.pop()
        let player2 = activeUsers.pop()

        let newGame = new Game(newGameCounter,player1,player2)

        activeGames.push(newGame)

        console.log(`\n New game started with ID: ${newGame.gameID} and players ${newGame.player1.userName} and ${newGame.player2.userName} \n`)
...
module.exports = {canGameBegin, activeGames, newGameCounter}